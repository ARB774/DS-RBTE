...
| `routing` | типизированные передачи результатов между ATB, TOC, PSD, OCE и adult-learning | копирование предметного знания или автоматический выбор следующего маршрута |
...
`id`, `name`, `fpf_commit`, `pack_toc_commit`, `pack_adult_learning_commit`, `pack_atb_commit` nullable, `manifest_hash`, `compatibility_status`, `created_at`, `activated_at`, `retired_at`.
