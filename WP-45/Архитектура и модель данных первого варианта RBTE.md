...
| `routing` | типизированные передачи результатов между ATB, TOC, DOCA, PSD, OCE, HCD, RMP, SIE и adult-learning | копирование предметного знания или автоматический выбор следующего маршрута |
